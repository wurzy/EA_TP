...
public class ResourcesDAO {
	...
	public static Resources loadResourcesByORMID(int idResource, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = UntitledPersistentManager.instance().getSession();
	...
	public static Resources getResourcesByORMID(int idResource, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = UntitledPersistentManager.instance().getSession();
	...
	public static Resources loadResourcesByORMID(PersistentSession session, int idResource, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
	...
	public static Resources getResourcesByORMID(PersistentSession session, int idResource, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
	...
	public static List queryResources(String condition, String orderBy, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = UntitledPersistentManager.instance().getSession();
	...
	public static Resources[] listResourcesByQuery(String condition, String orderBy, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = UntitledPersistentManager.instance().getSession();
	...
	public static List queryResources(PersistentSession session, String condition, String orderBy, org.hibernate.LockMode lockMode) throws PersistentException {
		StringBuffer sb = new StringBuffer("From Resources as Resources");
		if (condition != null)
			sb.append(" Where ").append(condition);
		if (orderBy != null)
	...
	public static Resources[] listResourcesByQuery(PersistentSession session, String condition, String orderBy, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
	...
	public static Resources loadResourcesByQuery(String condition, String orderBy, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = UntitledPersistentManager.instance().getSession();
	...
	public static Resources loadResourcesByQuery(PersistentSession session, String condition, String orderBy, org.hibernate.LockMode lockMode) throws PersistentException {
	...
	public static java.util.Iterator iterateResourcesByQuery(String condition, String orderBy, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = UntitledPersistentManager.instance().getSession();
	...
	public static java.util.Iterator iterateResourcesByQuery(PersistentSession session, String condition, String orderBy, org.hibernate.LockMode lockMode) throws PersistentException {
		StringBuffer sb = new StringBuffer("From Resources as Resources");
		if (condition != null)
			sb.append(" Where ").append(condition);
		if (orderBy != null)
	...
	public static boolean deleteAndDissociate(Resources resources, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (resources.getIdResourceType() != null) {
				resources.getIdResourceType().resources.remove(resources);
			}
