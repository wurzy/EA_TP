...
public class RolesDAO {
	...
	public static Roles loadRolesByORMID(int idRole, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = UntitledPersistentManager.instance().getSession();
	...
	public static Roles getRolesByORMID(int idRole, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = UntitledPersistentManager.instance().getSession();
	...
	public static Roles loadRolesByORMID(PersistentSession session, int idRole, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
	...
	public static Roles getRolesByORMID(PersistentSession session, int idRole, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(Roles roles, org.orm.PersistentSession session)throws PersistentException {
		try {
			Users[] lUserss = roles.users.toArray();
			for(int i = 0; i < lUserss.length; i++) {
				lUserss[i].setIdRole(null);
