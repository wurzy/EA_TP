...
public class FilesDAO {
	...
	public static Files loadFilesByORMID(int idFile, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = UntitledPersistentManager.instance().getSession();
	...
	public static Files getFilesByORMID(int idFile, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = UntitledPersistentManager.instance().getSession();
	...
	public static Files loadFilesByORMID(PersistentSession session, int idFile, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
	...
	public static Files getFilesByORMID(PersistentSession session, int idFile, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
	...
	public static List queryFiles(String condition, String orderBy, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = UntitledPersistentManager.instance().getSession();
	...
	public static Files[] listFilesByQuery(String condition, String orderBy, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = UntitledPersistentManager.instance().getSession();
	...
	public static List queryFiles(PersistentSession session, String condition, String orderBy, org.hibernate.LockMode lockMode) throws PersistentException {
		StringBuffer sb = new StringBuffer("From Files as Files");
		if (condition != null)
			sb.append(" Where ").append(condition);
		if (orderBy != null)
	...
	public static Files[] listFilesByQuery(PersistentSession session, String condition, String orderBy, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
	...
	public static Files loadFilesByQuery(String condition, String orderBy, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = UntitledPersistentManager.instance().getSession();
	...
	public static Files loadFilesByQuery(PersistentSession session, String condition, String orderBy, org.hibernate.LockMode lockMode) throws PersistentException {
	...
	public static java.util.Iterator iterateFilesByQuery(String condition, String orderBy, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = UntitledPersistentManager.instance().getSession();
	...
	public static java.util.Iterator iterateFilesByQuery(PersistentSession session, String condition, String orderBy, org.hibernate.LockMode lockMode) throws PersistentException {
		StringBuffer sb = new StringBuffer("From Files as Files");
		if (condition != null)
			sb.append(" Where ").append(condition);
		if (orderBy != null)
	...
	public static boolean deleteAndDissociate(Files files, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (files.getIdResource() != null) {
				files.getIdResource().files.remove(files);
			}
