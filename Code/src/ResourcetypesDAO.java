...
public class ResourcetypesDAO {
	...
	public static Resourcetypes loadResourcetypesByORMID(int idResourceType, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = UntitledPersistentManager.instance().getSession();
	...
	public static Resourcetypes getResourcetypesByORMID(int idResourceType, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = UntitledPersistentManager.instance().getSession();
	...
	public static Resourcetypes loadResourcetypesByORMID(PersistentSession session, int idResourceType, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
	...
	public static Resourcetypes getResourcetypesByORMID(PersistentSession session, int idResourceType, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
	...
	public static List queryResourcetypes(String condition, String orderBy, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = UntitledPersistentManager.instance().getSession();
	...
	public static Resourcetypes[] listResourcetypesByQuery(String condition, String orderBy, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = UntitledPersistentManager.instance().getSession();
	...
	public static List queryResourcetypes(PersistentSession session, String condition, String orderBy, org.hibernate.LockMode lockMode) throws PersistentException {
		StringBuffer sb = new StringBuffer("From Resourcetypes as Resourcetypes");
		if (condition != null)
			sb.append(" Where ").append(condition);
		if (orderBy != null)
	...
	public static Resourcetypes[] listResourcetypesByQuery(PersistentSession session, String condition, String orderBy, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
	...
	public static Resourcetypes loadResourcetypesByQuery(String condition, String orderBy, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = UntitledPersistentManager.instance().getSession();
	...
	public static Resourcetypes loadResourcetypesByQuery(PersistentSession session, String condition, String orderBy, org.hibernate.LockMode lockMode) throws PersistentException {
	...
	public static java.util.Iterator iterateResourcetypesByQuery(String condition, String orderBy, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = UntitledPersistentManager.instance().getSession();
	...
	public static java.util.Iterator iterateResourcetypesByQuery(PersistentSession session, String condition, String orderBy, org.hibernate.LockMode lockMode) throws PersistentException {
		StringBuffer sb = new StringBuffer("From Resourcetypes as Resourcetypes");
		if (condition != null)
			sb.append(" Where ").append(condition);
		if (orderBy != null)
	...
	public static boolean deleteAndDissociate(Resourcetypes resourcetypes, org.orm.PersistentSession session)throws PersistentException {
		try {
			Resources[] lResourcess = resourcetypes.resources.toArray();
			for(int i = 0; i < lResourcess.length; i++) {
				lResourcess[i].setIdResourceType(null);
