...
public class RatingsDAO {
	...
	public static Ratings loadRatingsByORMID(int idRatings, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = UntitledPersistentManager.instance().getSession();
	...
	public static Ratings getRatingsByORMID(int idRatings, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = UntitledPersistentManager.instance().getSession();
	...
	public static Ratings loadRatingsByORMID(PersistentSession session, int idRatings, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
	...
	public static Ratings getRatingsByORMID(PersistentSession session, int idRatings, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(Ratings ratings, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (ratings.getIdResource() != null) {
				ratings.getIdResource().ratings.remove(ratings);
			}
